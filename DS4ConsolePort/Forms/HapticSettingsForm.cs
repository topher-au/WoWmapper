...
namespace DS4ConsolePort
{
    public partial class HapticSettingsForm : Form
    {
        public HapticSettingsForm()
        {
            ...
            groupLightBar.Text = Properties.Resources.STRING_HAPTICS_LB_SETTINGS;
            groupVibration.Text = Properties.Resources.STRING_HAPTICS_RUMBLE_SETTINGS;
            groupMiscellaneous.Text = Properties.Resources.STRING_MISC;

            checkColorClass.Text = Properties.Resources.STRING_HAPTIC_LBCLASS;
            checkColorHealth.Text = Properties.Resources.STRING_HAPTIC_LBHEALTH;
            ...
            checkStickyCursor.Text = Properties.Resources.STRING_ENABLE_STICKY_CURSOR;
