...
namespace DS4CP_Updater
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var ds4c = Process.GetProcessesByName("DS4ConsolePort");
            if (ds4c.Length == 0) ds4c = Process.GetProcessesByName("DS4ConsolePort.vshost");
            if(ds4c.Length > 0)
            if(ds4c[0] != null)
            {
                var ds4p = ds4c[0];
            ...
            File.Delete(args[1]);
            Process.Start("DS4ConsolePort.exe", "-updated");
        }
    }
}
