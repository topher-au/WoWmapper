...
namespace WoWmapper
{
    public partial class ConfigForm : Form
    {
        ...
        public void InitializeForm()
        {
            ...
            labelAdvancedSettings.Text = Properties.Resources.STRING_SETTING_ADVANCED;
            ...
            buttonEnhancedSettings.Text = Properties.Resources.STRING_SETTING_CONFIG_ADVANCED_HAPTICS;
            ...
            buttonEnhancedSettings.Enabled = Properties.Settings.Default.EnableAdvancedHaptics;
        }

        private void buttonAdvancedHaptics_Click(object sender, EventArgs e)
        {
            EnhancedSettingsForm hsf = new EnhancedSettingsForm();
            hsf.ShowDialog();
        }
