...
namespace WoWmapper.Input
{
    public static class KeyInput
    {
        ...
        public static INPUT[] SynthMouse(MouseButton button, bool state)
        {
        ...
        public static void SendMouse(MouseButton button, bool state)
        {
            var inputs = SynthMouse(button, state);
            SendInput((uint)inputs.Length, inputs, INPUT.Size);
        }
    }
}