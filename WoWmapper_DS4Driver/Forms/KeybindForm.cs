...
namespace WoWmapper_DS4Driver.Forms
{
    public partial class KeybindForm : Form
    {
        ...
        private void DoKeyBind(TextBox BindBox, string Image, InputButton Button, Keys Key)
        {
            var BindForm = new BindKeyForm(null, Button, Key, kb.Keybinds);
            BindForm.ShowDialog();
        ...
        private void BindBox_DoubleClick(object sender, EventArgs e)
        {
            ...
            DoKeyBind(bindBox,
                null, //Properties.Resources.ResourceManager.GetObject(bindBox.Tag.ToString()) as Bitmap
                button,
